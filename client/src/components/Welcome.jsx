...
const url = "https://www.youtube.com/watch?v=Wn_Kb3MR_cU";
import { Loader } from './';
      ...
      <div className="flex md:flex-row flex-col items-start justify-between md:p-20-py-12 px-4">
        <div className='flex flex-1 justify-start flex-col md:mr-10'>
          ...
          <div className='flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10'>
            <div className='p-3 rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism flex-col justify-end items-start'>
              <div className='flex justify-between flex-col w-full h-full'>
                <div className='flex justify-between items-start'>
                  <div className='w-10 h-10 rounded-full border-2 border-white flex justify-center items-center'>
                    <SiEthereum fontSize={21} color="#fff" className='text-white' />
                  </div>
                </div>
              </div>
              </div>
